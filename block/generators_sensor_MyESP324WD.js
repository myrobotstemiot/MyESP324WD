module.exports = function(Blockly){
  'use strict';
	...
	Blockly.JavaScript['MyESP324WD_ADC_MCP3008'] = function(block) {
	  var value_pin = block.getFieldValue('pin');
	  var code = `ADC_Read(${value_pin})`;
	  return [code, Blockly.JavaScript.ORDER_ATOMIC];
	};
	Blockly.JavaScript['MyESP324WD_Knob_status'] = function(block) {
	  var value_pin = block.getFieldValue('pin');
...
*/
	...
	Blockly.JavaScript['MyESP324WD_Light_sensor'] = function(block) {
	  var value_pin = block.getFieldValue('pin');  
	  var code = `ADC_Read(${value_pin})`;
	  return [code, Blockly.JavaScript.ORDER_ATOMIC];
	};
	Blockly.JavaScript['MyESP324WD_Switch_sensor'] = function(block) {
	  var value_pin = block.getFieldValue('pin');  
	  var code = `in(${value_pin})`;
	  return [code, Blockly.JavaScript.ORDER_ATOMIC];
	};
	Blockly.JavaScript['MyESP324WD_Distance_sensor'] = function(block) {
	  var value_pin = block.getFieldValue('pin');  
	  var code = `ADC_Read(${value_pin})`;
	  return [code, Blockly.JavaScript.ORDER_ATOMIC];
	};
	...
	Blockly.JavaScript['dhtesp_setup_MyESP324WD'] = function(block) {
	...
	Blockly.JavaScript['dhtesp_read_temp_MyESP324WD'] = function(block) {
	  var variable_instance = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('instance'), Blockly.Variables.NAME_TYPE);
	  var code = `${variable_instance}.readTemperature()`;
	  return [code, Blockly.JavaScript.ORDER_ATOMIC];
	};

	Blockly.JavaScript['dhtesp_read_humid_MyESP324WD'] = function(block) {
	  var variable_instance = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('instance'), Blockly.Variables.NAME_TYPE);
	...
	Blockly.JavaScript['ds18b20_init_MyESP324WD'] = function(block) {
	  var number_pin = block.getFieldValue('pin');
	  var code = `#EXTINC
	#include <OneWire.h>
	...
	Blockly.JavaScript['ds18b20_get_devices_num_MyESP324WD'] = function(block) {
	  var code = `sensors_ds18b20.getDS18Count()`;
	  return [code, Blockly.JavaScript.ORDER_ATOMIC];
	};

	Blockly.JavaScript['ds18b20_get_temperature_MyESP324WD'] = function(block) {
...
//From ESP32 standart I/O
//
	Blockly.JavaScript['Light sensorSTD'] = function(block) {
	  var value_pin = block.getFieldValue('pin');  
