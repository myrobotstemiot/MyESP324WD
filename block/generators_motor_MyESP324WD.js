...
Blockly.JavaScript['MyESP324WD_motor'] = function(block) {
...
Blockly.JavaScript['MyESP324WD_motor_turn'] = function(block) {
...
Blockly.JavaScript['MyESP324WD_motor_Spin'] = function(block) {
  var value_dir = block.getFieldValue('dir');
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
...
Blockly.JavaScript['MyESP324WD_motor_Spin_Time'] = function(block) {
  var value_dir = block.getFieldValue('dir');
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
...
Blockly.JavaScript['MyESP324WD_motor_stop_ch'] = function(block) {
  var dropdown_ch = block.getFieldValue('ch');
...
Blockly.JavaScript['MyESP324WD_servo'] = function(block) {
  var dropdown_ch = block.getFieldValue('ch');
...
Blockly.JavaScript['MyESP324WD_servo2'] = function(block) {
  var dropdown_ch = block.getFieldValue('ch');
  var dropdown_dir = block.getFieldValue('dir');
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || 0;
...
Blockly.JavaScript['MyESP324WD_motor_forward'] = function(block) {
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
...
Blockly.JavaScript['MyESP324WD_motor_backward'] = function(block) {
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
...
Blockly.JavaScript['MyESP324WD_motor_turn_left'] = function(block) {
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
  code += 'motor(1, 1, 0);\t';
  code += 'motor(2, 1, ' + value_speed + ');\n';
...
Blockly.JavaScript['MyESP324WD_motor_turn_right'] = function(block) {
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
  code += 'motor(1, 1, ' + value_speed + ');\t';
  code += 'motor(2, 1, 0);\n';
...
Blockly.JavaScript['MyESP324WD_motor_spin_left'] = function(block) {
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
  code += 'motor(1, 2, ' + value_speed + ');\t';
  code += 'motor(2, 1, ' + value_speed + ');\n';
...
Blockly.JavaScript['MyESP324WD_motor_spin_right'] = function(block) {
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
  code += 'motor(1, 1, ' + value_speed + ');\t';
  code += 'motor(2, 2, ' + value_speed + ');\n';
...
Blockly.JavaScript['MyESP324WD_motor_stop'] = function(block) {  
  var code = 'ao();\n';
  return code;
};

Blockly.JavaScript['MyESP324WD_motor_backward2'] = function(block) {
...
Blockly.JavaScript['MyESP324WD_PID_setPin'] = function(block) {
...
Blockly.JavaScript['MyESP324WD_PID_setMin'] = function(block) {
  var value_numSensor = block.getFieldValue('numSensor');
  var value_s0 = Blockly.JavaScript.valueToCode(block, 'S0', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var value_s1 = Blockly.JavaScript.valueToCode(block, 'S1', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var value_s2 = Blockly.JavaScript.valueToCode(block, 'S2', Blockly.JavaScript.ORDER_ATOMIC) || '0';
...
Blockly.JavaScript['MyESP324WD_PID_setMax'] = function(block) {
  var value_numSensor = block.getFieldValue('numSensor');
  var value_s0 = Blockly.JavaScript.valueToCode(block, 'S0', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var value_s1 = Blockly.JavaScript.valueToCode(block, 'S1', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var value_s2 = Blockly.JavaScript.valueToCode(block, 'S2', Blockly.JavaScript.ORDER_ATOMIC) || '0';
...
Blockly.JavaScript['MyESP324WD_Run_PID'] = function(block) {
  var value_speed = Blockly.JavaScript.valueToCode(block, 'speed', Blockly.JavaScript.ORDER_ATOMIC) || '0';
...
Blockly.JavaScript['MyESP324WD_Mecanum'] = function(block) {
  ...
  var code = '';
   code += 'mecanum('+value_status+', ' + value_speed1 + ', ' + value_speed2 + ', ' + value_speed3 + ', ' + value_speed4 + ');\n';
return code;
};

Blockly.JavaScript['MyESP324WD_MecanumT'] = function(block) {
  var value_status = block.getFieldValue('dir');
  var value_speed1 = Blockly.JavaScript.valueToCode(block, 'speed1', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var value_speed2 = Blockly.JavaScript.valueToCode(block, 'speed2', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var value_speed3 = Blockly.JavaScript.valueToCode(block, 'speed3', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  ...
  var code = '';
   code += 'mecanumT('+value_status+', ' + value_speed1 + ', ' + value_speed2 + ', ' + value_speed3 + ', ' + value_speed4 +', ' + value_timer + ');\n';
return code;
};

Blockly.JavaScript['MyESP324WD_Motorall'] = function(block) {
  var value_status = block.getFieldValue('dir');
  var value_speed1 = Blockly.JavaScript.valueToCode(block, 'speed1', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var value_speed2 = Blockly.JavaScript.valueToCode(block, 'speed2', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var value_speed3 = Blockly.JavaScript.valueToCode(block, 'speed3', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var value_speed4 = Blockly.JavaScript.valueToCode(block, 'speed4', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
   code += 'motorall('+value_status+', ' + value_speed1 + ', ' + value_speed2 + ', ' + value_speed3 + ', ' + value_speed4 + ');\n';
return code;
};

Blockly.JavaScript['MyESP324WD_MotorallT'] = function(block) {
  var value_status = block.getFieldValue('dir');
  var value_speed1 = Blockly.JavaScript.valueToCode(block, 'speed1', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var value_speed2 = Blockly.JavaScript.valueToCode(block, 'speed2', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var value_speed3 = Blockly.JavaScript.valueToCode(block, 'speed3', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  ...
  var value_timer = Blockly.JavaScript.valueToCode(block, 'timer', Blockly.JavaScript.ORDER_ATOMIC) || '0';
  var code = '';
   code += 'motorallT('+value_status+', ' + value_speed1 + ', ' + value_speed2 + ', ' + value_speed3 + ', ' + value_speed4 +', ' + value_timer + ');\n';
return code;
};
