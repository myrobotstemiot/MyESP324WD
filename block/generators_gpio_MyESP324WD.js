module.exports = function(Blockly) {
  "use strict";
  Blockly.JavaScript["ADC_MyESP324WD"] = function(block) {
    let dropdown_CH = block.getFieldValue("pin");
    let code = `analog(${dropdown_CH})`;
    return [code, Blockly.JavaScript.ORDER_ATOMIC];
  };
  Blockly.JavaScript["IN_MyESP324WD"] = function(block) {
    let dropdown_CH = block.getFieldValue("pin");
    let code = `in(${dropdown_CH})`;
    return [code, Blockly.JavaScript.ORDER_ATOMIC];
  };
  Blockly.JavaScript["IN_PULLUP_MyESP324WD"] = function(block) {
    let dropdown_CH = block.getFieldValue("pin");
    let code = `in_pullup(${dropdown_CH})`;
    return [code, Blockly.JavaScript.ORDER_ATOMIC];
  };
  Blockly.JavaScript["OUT_MyESP324WD"] = function(block) {
  ...
  Blockly.JavaScript["io_pin_dummy_input"] = function(block) {
    ...
    Blockly.JavaScript["SW_MyESP324WD"] = function(block) {
    let dropdown_CH = block.getFieldValue("pin");
