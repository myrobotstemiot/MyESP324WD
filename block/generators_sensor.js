module.exports = function(Blockly){
  'use strict';
	...
	Blockly.JavaScript['ADC sensor'] = function(block) {
	  let value_chan = block.getFieldValue('chan');  
//	  let code = `a2d(${value_chan})`;
	  let code = `adc.analogRead(${value_chan})`;
//	  let code = `adc.analogRead(0)`;
