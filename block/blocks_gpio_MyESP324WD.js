module.exports = function(Blockly) {
  ...
  Blockly.Blocks["IN_PULLUP_MyESP324WD"] = {
    init: function() {
      this.appendDummyInput()
  ...
  Blockly.Blocks['OUT_MyESP324WD'] = {
   ...
   Blockly.Blocks['Buzzer_MyESP324WD'] = {
    init: function() {
      this.appendDummyInput()
  ...
  Blockly.Blocks['Knob_MyESP324WD'] = {
    init: function() {
      this.appendDummyInput()
